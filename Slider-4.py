...
from control2 import ADDR_MX_TORQUE_ENABLE, ADDR_MX_PRESENT_POSITION

# Control table address
ADDR_MX_TORQIUE_ENABLE = 24
ADDR_MX_GOAL_POSITION = 30
ADDR_MX_PRESENT_POSTION = 36
...
previous_goal_positions = [-1, -1, -1, -1]
...
slider4 = tk.Scale(root, from_=0, to=1023, orient=tk.HORIZONTAL, length=300, command=on_slider_change)
slider4.pack()
